...
export const configValidationSchema = Joi.object({
  ...
  // DB
  [DBConfigKeys.DB_DIALECT]: Joi.string().required(),
  [DBConfigKeys.DB_HOST]: Joi.string().required(),
  [DBConfigKeys.DB_PORT]: Joi.number().required(),
  ...
  [DBConfigKeys.DB_AUTO_LOAD_MODELS]: Joi.boolean().required(),
